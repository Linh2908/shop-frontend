    ...
    return (
        <tr>
            ...
            <td className={productStyle.actions}>
                <Button variant='success' className='m-3' onClick={() => handleToggleShowEditModal()}>Sua</Button>
                <Button variant='danger' className='m-3' onClick={() => handleToggleShowDeleteModal()}>Xoa</Button>
            </td>
            {
