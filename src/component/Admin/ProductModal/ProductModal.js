  ...
  return (
    <Modal show={isShow} onHide={() => handleCloseModal()}>
      ...
      <Form>
        ...
        <Modal.Body>
          <Form.Group>
            <Form.Label htmlFor="name">Ten  :</Form.Label>
            <Form.Control
              name="name"
              id="name"
          ...
          <Form.Group>
            <Form.Label htmlFor="brand">Hang :</Form.Label>
            <Form.Control
              ref={brandRef}
              name="brand"
              id="brand"
          ...
          <Form.Group>
            <Form.Label htmlFor="category">Loai :</Form.Label>
            <Form.Control
              ref={categoryRef}
              name="category"
              id="category"
          ...
          <Form.Group>
            <Form.Label htmlFor="description">Mieu ta :</Form.Label>
            <Form.Control
              as={"textarea"}
              rows="3"
              ref={descriptionRef}
          ...
          <Form.Group>
            <Form.Label htmlFor="numReviews">So luong danh gia :</Form.Label>
            <Form.Control
              ref={numReviewsRef}
              name="numReviews"
              id="numReviews"
          ...
          <Form.Group>
            <Form.Label htmlFor="image">Anh :</Form.Label>
            <Form.Control
            ref={imageRef}
              name="image"
              id="image"
